...
use bevy_egui::{egui::{Slider, Window}, EguiContexts, EguiPlugin};
use bevy_panorbit_camera::{PanOrbitCamera, PanOrbitCameraPlugin};
use bevy_shader_mtoon::{MtoonBundle, MtoonMaterial, HMtoonMaterial, MtoonPlugin, MtoonSun, OutlineMode};
...
fn setup(
    ...
    let mtoon_textured = MtoonBundle {
        mtoon: HMtoonMaterial(mtoon_materials.add(MtoonMaterial{
...
fn rotate(time: Res<Time>, mut query: Query<&mut Transform, With<HMtoonMaterial>>) {
